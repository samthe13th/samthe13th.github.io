...
var slider = Slider(sandbox, 100, 460, 430, maxTime, drag);
...
function makeScreen2() {
    ...
    var angle_slider = Slider(screen2, 90, param_offset_y + 40, 300, 180, drag_angle);
    ...
    var height_slider = Slider(screen2, 90, (param_offset_y + 120), 300, 100, drag_height);
    ...
    var speed_slider = Slider(screen2, 90, (param_offset_y + 200), 300, 40, drag_speed);
